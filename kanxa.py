#!/usr/bin/python2
# coding=utf-8
# Coded By samerhoni001
# My Facebook ( https://www.facebook.com/samery.honi.feri)
...
\033[1;95m|| Created By SAMRR-DON
\033[1;94m|| Github.com/samerhoni001
\033[0;91mv2.0  \033[0m|| Facebook.SAMER HONI'''
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : samerhoni001'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : samerhoni001(RK).'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/samerhoni001'%(N,H,N);time.sleep(0.07)
